...
//
// This java program runs PCraw, captures stdin output and display.
// This wrapper can be extended to create a platform independent GUI
// For PCraw.
//
...
class Jpcraw {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // This will block here, and won't be able to output in real time.
            // so remove this, then it'll output in real time.
            //oProcess.waitFor();
        } catch (Exception e) {
